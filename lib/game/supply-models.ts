...
function buildSupplyModel(kind: number) {
  ...
  if (kind === 8) {
    ...
    k.add(new THREE.PlaneGeometry(0.07, 0.16), '#438caa', 0, -0.02, 0.32);
    k.add(new THREE.PlaneGeometry(0.18, 0.05), '#438caa', 0, -0.02, 0.322);
  } else {
    box(0.73, 0.56, 0.45, '#cd6356', 0, 0, 0, 0.065);
    box(0.76, 0.095, 0.48, '#364751', 0, -0.15, 0);
    k.add(new THREE.PlaneGeometry(0.54, 0.035), '#f0c1a0', 0, 0.2, 0.26);
    k.add(new THREE.PlaneGeometry(0.34, 0.09), '#fff5dd', 0, 0.04, 0.27);
    k.add(new THREE.PlaneGeometry(0.09, 0.3), '#fff5dd', 0, 0.04, 0.272);
